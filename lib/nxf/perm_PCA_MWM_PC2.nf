...
process perm {
    ...
    Rscript \$HOME/git/mwm/lib/R/PCA_perm_test_nf_optimized_PC2.R --path2files=\$(readlink ${MWM_file}) --seed=${perm}    
    """ 
}
...
tbl_t_stat
    ...
    .subscribe {
        ...
        it.copyTo( dump_dir.resolve ( "PCA_t_statistic_PC2_${start_perm}_day5.csv" ) )
    }
...
tbl_t_stat_day1
    ...
    .subscribe {
        //println "Entries are saved to file: $it"
        //println "File content is: ${it.text}"
        it.copyTo( dump_dir.resolve ( "PCA_t_statistic_PC2_${start_perm}_day1.csv" ) )
    }
