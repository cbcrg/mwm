...
#########################################################################################
### On this commit to github repo they restore bin to the function                    ###
### https://github.com/hadley/ggplot2/commit/91c8bf136969a28fa81a4c226cab78faa05257ce ###
### but it is not available yet when uploading the library                            ###
### I source this script directly in the code                                         ### 
#########################################################################################
